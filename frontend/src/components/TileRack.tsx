...
export function TileRack() {
  ...
  return (
    <div className="flex flex-col items-center gap-3 w-full max-w-lg mx-auto">
      ...
      {exchangeMode && (
        <div className="bg-blue-100 border border-blue-300 text-blue-800 px-4 py-2 rounded-lg text-sm font-medium w-full text-center">
          ...
          return (
            <button
              ...
              className={`
                ...
                ${isMarked ? "bg-blue-200 ring-2 ring-blue-500" : bg}
      ...
      <div className="flex gap-2 flex-wrap justify-center">
        {exchangeMode ? (
          <>
            <button onClick={cancelExchange} className="px-4 py-2 rounded-lg bg-stone-200 text-stone-700 font-medium hover:bg-stone-300 transition-colors">
              Cancel
            </button>
          ...
          <>
            <button onClick={clearPlacements} disabled={!canClear}
              className="px-4 py-2 rounded-lg bg-stone-200 text-stone-700 font-medium hover:bg-stone-300 disabled:opacity-40 disabled:cursor-not-allowed transition-colors">
              Clear
            </button>
            <button onClick={placeTiles} disabled={!canSubmit}
              className="px-6 py-2 rounded-lg bg-amber-600 text-white font-semibold hover:bg-amber-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors">
              Submit Move
            </button>
